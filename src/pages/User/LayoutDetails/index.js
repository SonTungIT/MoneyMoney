...
function LayoutDetails({ closeLayoutDetails, transactionData, onDeleteTransaction, onUpdateTransaction }) {
    ...
    const handleSaveChanges = () => {
        ...
        fetch(`https://moneymoney.azurewebsites.net/api/v1/money-money/users/incomes/${id}`, requestOptions)
    ...
    const handleDeleteTransaction = () => {
        ...
        fetch(`https://moneymoney.azurewebsites.net/api/v1/money-money/users/expenses/${id}`, requestOptions)
            .then((response) => response.text())
            .then((result) => {
                console.log(result);
                onDeleteTransaction(id);
